...
def sweep_xi_f_lam_rikmenspoel(argv):
    '''
    Sweeps over
        - f: frequency
        - lam: wavelength
        - xi: relative damping coefficient
    ...
    sweep_parser.add_argument('--xi', 
        type=float, nargs=3, default = [-3, -1.0, 0.5])
    sweep_parser.add_argument('--freq', 
        type=float, nargs=3, default = [10, 50, 5.0])    
    sweep_parser.add_argument('--lam', 
        type=float, nargs=3, default = [0.5, 2.0, 0.1])
    ...
    model_param.gsmo = True
    model_param.Ds_h=0.005
    model_param.Ds_t=0.005
    ...
    grid_param = {'eta': eta_param, 'T_c': T_c_param, 'lam': lam_param} 
...
if __name__ == '__main__':
    ...
    parser.add_argument('-sweep',  
        choices = ['a_b', 'A_lam_a_b', 'c_lam_a_b', 'mu_c_lam_fang_yen', 
            ...
            'f_rikmenspoel', 'f_lam_rikmenspoel', 'f_c_lam_rikmenspoel',
            'xi_f_lam_rikmenspoel'], help='Sweep to run')
